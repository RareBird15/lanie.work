...
```html
<p>
  This sentence uses <code>$</code> delimiters to show math inline:
  <math-renderer
...
```html
<p>
  This expression uses <code>\$</code> to display a dollar sign:
  <math-renderer>
    <math xmlns="http://www.w3.org/1998/Math/MathML">
      <msqrt>
        <mi>$</mi>
...
```html
<p>
  To split <span>$</span>100 in half, we calculate
  <math-renderer>
    <math xmlns="http://www.w3.org/1998/Math/MathML">
      <mn>100</mn>
