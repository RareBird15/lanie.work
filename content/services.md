...
date: 2026-04-13
description:
  Accessibility, usability, and product feedback from a blind, autistic, and chronically ill assistive technology user.
showDate: false
showTableOfContents: true
---

I'm currently available for freelance accessibility, usability, and product feedback work. I test websites, apps, games,
...
I can test a specific website, app, workflow, form, onboarding process, account setup, or feature using NVDA and
keyboard navigation.
...
I can provide practical feedback on whether a product feels usable, predictable, and respectful from the perspective of
someone who relies on assistive technology and has variable energy.
...
I can evaluate games and interactive experiences for barriers that affect blind players and disabled users with
