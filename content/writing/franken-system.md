...
Date: 2026-04-04
Category: Writing
Tags: accessibility, disability, technology, workflow
Slug: franken-system
Summary:
...
easy to get lost in a complex software menu as it is on a physical street), brand loyalty is a luxury. You cannot choose
...
Because no single tech giant has solved accessibility across all their products, I cannot stay within one walled garden.
...
graphical desktop is not a viable option for me. The Orca screen reader lacks the robust features of NVDA, there is far
...
This isn't just a tax on my time and energy; it is a financial tax. I cannot opt for a budget Android phone or a cheap
ChromeOS laptop. I am forced into higher price brackets simply because those are the only devices that offer the
baseline accessibility I need to function.
...
- **Notifications:** I can see notifications on my PC, but clicking on them does not open the corresponding app or
...
- **File Management:** I cannot easily access files stored on my PC from my iPhone. I have to use Google Drive as a
  middleman, which adds extra steps and potential points of failure.
- **App Ecosystem:** Many apps I use on my PC do not have iOS versions, and vice versa. This forces me to find
  alternative tools that may not be as effective or accessible.
- **Voice Assistants:** I cannot use Siri on my iPhone to control my PC, and I cannot use Copilot on my PC to control my
...
This lack of integration creates a constant friction point in my workflow. I am forced to find workarounds for tasks
...
features, your only option is ChatGPT. This lack of choice means I cannot tailor my AI assistance to my specific
disabilities.
...
smaller, specialized tools I rely on simply do not work. I am forced to choose between the cutting-edge AI that could
...
needs. Using Google services on an iPhone creates a functional but highly disconnected workflow. I am constantly jumping
...
Because this system is held together by digital duct tape, it is incredibly fragile. A single update from any one of
these companies can break a workaround I have relied on for years. I live in a constant state of low-level anxiety,
knowing that my ability to work or communicate depends on companies that do not even know my specific configuration
exists.
